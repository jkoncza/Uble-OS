...
static void pci_print_hex32(uint32_t value)
{
    ...
    text[0] = hex[(value >> 28) & 0x0F];
    text[1] = hex[(value >> 24) & 0x0F];
    text[2] = hex[(value >> 20) & 0x0F];
    text[3] = hex[(value >> 16) & 0x0F];
    text[4] = hex[(value >> 12) & 0x0F];
    text[5] = hex[(value >> 8) & 0x0F];
    text[6] = hex[(value >> 4) & 0x0F];
    text[7] = hex[value & 0x0F];
    text[8] = '\0';
