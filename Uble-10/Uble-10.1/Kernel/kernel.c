...
void draw_file_icon(uint32_t x, uint32_t y) {
    draw_rect(x + 5, y + 1, 18, 28, PAL_BLACK);
    draw_rect(x + 6, y + 2, 16, 26, PAL_WHITE);
    draw_rect(x + 21, y + 1, 2, 2, WIN1_BACKGROUND);
    draw_rect(x + 19, y + 2, 3, 1, PAL_DARK_WHITE);
    draw_rect(x + 19, y + 3, 2, 1, PAL_DARK_WHITE);
    draw_rect(x + 19, y + 4, 1, 1, PAL_DARK_WHITE);
    draw_rect(x + 18, y + 2, 1, 4, PAL_LIGHT_GRAY);
    draw_rect(x + 18, y + 5, 4, 1, PAL_LIGHT_GRAY);
    draw_rect(x + 9,  y + 8,  4, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 14, y + 9,  3, 1, PAL_LIGHT_BLUE);
    draw_rect(x + 18, y + 8,  2, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 9,  y + 12, 3, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 13, y + 13, 5, 1, PAL_LIGHT_BLUE);
    draw_rect(x + 19, y + 12, 2, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 21, y + 12, 1, 1, PAL_LIGHT_BLUE);
    draw_rect(x + 9,  y + 16, 2, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 13, y + 16, 4, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 17, y + 17, 1, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 19, y + 16, 3, 1, PAL_LIGHT_BLUE);
    draw_rect(x + 9,  y + 21, 5, 1, PAL_LIGHT_BLUE);
    draw_rect(x + 15, y + 20, 3, 2, PAL_LIGHT_BLUE);
    draw_rect(x + 19, y + 21, 1, 1, PAL_LIGHT_BLUE);
}
